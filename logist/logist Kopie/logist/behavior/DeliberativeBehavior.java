...
public interface DeliberativeBehavior {
	 ...
	 * <ul>
	 * <li>{@link logist.agent.Agent#vehicles()} the list of vehicles controlled
	 * by the agent</li>
	 * <li>{@link logist.agent.Agent#getTasks()} the set of tasks that the agent
	 ...
	 * {@link logist.behavior.DeliberativeBehavior#planCancelled(logist.task.TaskSet)}
	 * ).
	 * 
	 * @param vehicle
	 ...
	 * {@link logist.behavior.DeliberativeBehavior#plan(logist.simulation.Vehicle, logist.task.TaskSet)}
